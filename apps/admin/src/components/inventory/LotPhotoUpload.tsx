...
export default function LotPhotoUpload({ lotId, kind, onUploaded }: Props) {
  ...
  return (
    <div className="inline-block">
      <input
        ...
        className="hidden"
        id={`photo-upload-${lotId}-${kind}`}
      />
      <label htmlFor={`photo-upload-${lotId}-${kind}`} className="cursor-pointer">
