...
export default function MarkSoldModal({ lot, onClose, onSaleCreated }: Props) {
  ...
  const handleUpdateConsumable = (
    ...
    if (field === "consumable_id") {
      const consumable = consumables.find((c) => c.consumable_id === (value as string));
      updated[index] = {
        ...updated[index],
  ...
  const handleSubmit = async () => {
    ...
    if (!lot.for_sale) {
      setErrorModal({
        isOpen: true,
        message: "This lot is not available for sale. It may be reserved in a bundle.",
      });
      return;
    }
    ...
    if (lot.available_qty <= 0) {
      setErrorModal({
        isOpen: true,
        message: "No quantity available for sale. This lot may be reserved in a bundle.",
      });
      return;
    }
    ...
    if (qty <= 0 || qty > lot.available_qty) {
      setErrorModal({
        isOpen: true,
        message: `Quantity must be between 1 and ${lot.available_qty}`,
      });
      return;
    }
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <div className="text-sm">
              ...
              <div className="text-gray-600 text-xs mb-2">
                Condition: {lot.condition} {lot.variation && `| Variation: ${lot.variation}`} |
                Total Quantity: {lot.quantity} | Sold: {lot.sold_qty}
              </div>
          ...
          <div>
            ...
            {lot.available_qty > 1 && (
              <p className="text-xs text-gray-600 mt-1">
                You can sell up to {lot.available_qty} {lot.available_qty !== 1 ? "copies" : "copy"}{" "}
                at once
              </p>
            )}
          </div>
          ...
          <div className="relative">
            ...
            <Input
              ...
              onFocus={() => {
                // Order group suggestions are handled via datalist
              }}
                ...
                {selectedConsumables.map((consumable, index) => (
                  <div key={index} className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                    <select
                      ...
                      onChange={(e) =>
                        handleUpdateConsumable(index, "consumable_id", e.target.value)
                      }
          ...
          <div className="border-t border-gray-200 pt-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-yellow-700 mt-1">
                      Break-even price: £{profit.breakEven.toFixed(2)}. Current price may result in
                      a loss.
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
              ...
              <div className="border-t border-gray-300 pt-2 flex justify-between">
                ...
                <span
                  className={`font-bold ${profit.netProfit >= 0 ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${profit.margin >= 0 ? "text-green-600" : "text-red-600"}`}
                >
