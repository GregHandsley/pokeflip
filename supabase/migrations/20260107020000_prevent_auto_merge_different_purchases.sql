-- =========================
-- Prevent auto-merging lots from different purchases
-- =========================

-- Update commit_acquisition to only merge lots from the SAME purchase
-- This ensures cards from different purchases remain separate
