-- Fix commit_acquisition: avoid referencing non-existent r.id field when merging/inserting
-- Uses a dedicated variable for the lot id returned by update/insert.
